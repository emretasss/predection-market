...
export interface Client {
     ...
     */
    create_market: ({ creator, question, description, token, end_time }: {
        creator: string;
        question: string;
        description: string;
        token: string;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        create_market: (json: string) => AssembledTransaction<bigint>;
        predict: (json: string) => AssembledTransaction<null>;
        resolve_market: (json: string) => AssembledTransaction<null>;
        claim_winnings: (json: string) => AssembledTransaction<bigint>;
        get_market: (json: string) => AssembledTransaction<Market>;
        get_user_prediction: (json: string) => AssembledTransaction<Option<Prediction>>;
        get_market_count: (json: string) => AssembledTransaction<bigint>;
        get_platform_fee_rate: (json: string) => AssembledTransaction<bigint>;
        set_platform_fee_rate: (json: string) => AssembledTransaction<null>;
        update_admin: (json: string) => AssembledTransaction<null>;
        get_admin: (json: string) => AssembledTransaction<string>;
        get_winning_side: (json: string) => AssembledTransaction<Option<PredictionSide>>;
    };
}
